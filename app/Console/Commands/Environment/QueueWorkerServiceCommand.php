...
class QueueWorkerServiceCommand extends Command
{
    ...
    {
        $serviceName = $this->option('service-name') ?? $this->ask('Queue worker service name', 'lionpanel-queue');
...
After=redis-server.service' : '';
        ...
        $success = File::put($path, "# LionPanel Queue File
# ----------------------------------

[Unit]
Description=LionPanel Queue Service$afterRedis
